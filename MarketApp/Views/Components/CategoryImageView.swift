...
struct CategoryImageView: View {
    ...
    @StateObject var viewModel: CategoryImageViewViewModel
    
    init(categoryItem: CategoryItem) {
        _viewModel = StateObject(wrappedValue: CategoryImageViewViewModel(categoryItem: categoryItem))
